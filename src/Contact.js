...
import image4 from './Images/left-quote.png';
...
<img className="mx-auto d-block pt-5 text-white" src={image4} alt="image4"></img>
<p className="text-center pb-5 quote">Optimism is an occupational hazard of programming: feedback is the treatment.</p>
<div className="container">
<div className="row">
  <div className="col-lg-8 col-md-8">
            <div className=" d-flex justify-content-center">
            <svg xmlns="http://www.w3.org/2000/svg" id="ku" width="70%" baseProfile="tiny" className="svgmate" version="1" viewBox="300 150 550 400">
...
<h4 className="text-center touch">Get in Touch</h4>
<div className="form-group">
    <input style={{color:'#fff'}} type="text" className="form-control" id="name" aria-describedby="etextHelp" placeholder="Your Name" />
  </div>
  <div className="form-group">
    <input style={{color:'#fff'}} type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Your Email" />
  </div>
  <div className="form-group pb-3">
    <input style={{color:'#fff'}} type="message" className="form-control" id="exampleInputmessage" aria-describedby="emailHelp" placeholder="Your Messsage" />
  </div>
  <button type="submit" className="btn container-fluid " style={{padding: "7px 20px",borderRadius:" 25px"}}>Send</button>
</form>
</div>
</div>
<Social2/>
