...
function Social2() {
    return (
        <>
            <div className="social-icons2 d-flex justify-content-center pt-5 pb-5">

<a className="social1 twitter" href="https://twitter.com/Akshita2664" target="_blank" rel="noreferrer">
    <svg className="twitter-icon pe-2" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" enable-background="new 0 0 500 500" xmlSpace="preserve">
...
<a className="social1 linkedin pe-2" href="https://www.linkedin.com/in/akshita102jain" target="_blank" rel="noreferrer">
    <svg className="linkedin-icon" xmlns="http://www.w3.org/2000/svg" width="35" viewBox="0 0 24 24" fill="#0e76a8" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
        <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path>
        <rect id="link1" x="2" y="9" width="4" height="12" />
        <circle id="link2" cx="4" cy="4" r="2" />
    </svg>
</a>
<a className="social1 instagram" href="https://www.instagram.com/akshita_jain_26/" target="_blank" rel="noreferrer">
    <svg className="instagram-icon" x="0px" y="0px" viewBox="0 0 202.5 202.5">
        ...
        <circle id="shutter" className="st0" cx="101" cy="101.5" r="8" />
        <circle id="lens" className="st0" cx="125.5" cy="78.6" r="2.9" />
        <path id="camera" className="st0" d="M79,60.5h44c10.5,0,19,8.5,19,19v44c0,10.5-8.5,19-19,19H79c-10.5,0-19-8.5-19-19v-44
                                                                                C60,69,68.5,60.5,79,60.5z" />
    </svg>
</a>

<a className="social1 github pe-2" href="https://github.com/akshitajain26" target="_blank" rel="noreferrer">
